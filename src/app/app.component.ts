...
export class MyApp {
  ...
  constructor(public platform: Platform,
    ...
    // this.notifyService.sendMessage("hello,subject");
    // this.notifyService.getMessage().subscribe((data)=>{
    //   console.log("收到发来的信息是", data);
    // })
    ...
    /*
            ...
            let ws = new SockJS("http://crland.ttoto.net:60443/ws");
    ...
    */
    ...
    this.pages = [
      ...
      {title: '锁定app', component: LockAppPage}
    ];
